<div class="navbar-wrap fixed top-4 left-1/2 -translate-x-1/2 z-[1000] 
            ...
            max-[480px]:w-[calc(100%_-_32px)] max-[480px]:top-[10px]">
    <div class="max-w-[1280px] mx-auto px-10 max-md:px-5">
        <nav class="flex items-center justify-between py-[14px] px-[28px]">
            <a href="#" class="logo font-mono text-[1.8rem] tracking-[-2px] 
            ...
            <div class="nav-actions flex gap-3 items-center">
                <a href="#" class="btn inline-flex items-center justify-center gap-2 
                                   ...
                                   bg-black text-white shadow-[8px_8px_0px_var(--color-cyan)] 
